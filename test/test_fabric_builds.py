...
class TestFabricBuilds(unittest.TestCase):
    """FabricBuilds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FabricBuilds:
        """Test FabricBuilds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FabricBuilds`
        """
        model = FabricBuilds()
        if include_optional:
            return FabricBuilds(
