...
class TestQuiltBuilds(unittest.TestCase):
    """QuiltBuilds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuiltBuilds:
        """Test QuiltBuilds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuiltBuilds`
        """
        model = QuiltBuilds()
        if include_optional:
            return QuiltBuilds(
