...
class TestNeoforgeBuilds(unittest.TestCase):
    """NeoforgeBuilds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NeoforgeBuilds:
        """Test NeoforgeBuilds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NeoforgeBuilds`
        """
        model = NeoforgeBuilds()
        if include_optional:
