...
class TestTeamPacks(unittest.TestCase):
    """TeamPacks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamPacks:
        """Test TeamPacks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamPacks`
        """
        model = TeamPacks()
        if include_optional:
            return TeamPacks(
