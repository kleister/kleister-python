...
class TestForgeBuilds(unittest.TestCase):
    """ForgeBuilds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForgeBuilds:
        """Test ForgeBuilds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForgeBuilds`
        """
        model = ForgeBuilds()
        if include_optional:
            return ForgeBuilds(
