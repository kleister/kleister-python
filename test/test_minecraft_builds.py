...
class TestMinecraftBuilds(unittest.TestCase):
    """MinecraftBuilds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MinecraftBuilds:
        """Test MinecraftBuilds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MinecraftBuilds`
        """
        model = MinecraftBuilds()
        if include_optional:
