...
class UserMod(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, mod_id, perm, *args, **kwargs):  # noqa: E501
        """UserMod - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, mod_id, perm, *args, **kwargs):  # noqa: E501
        """UserMod - a model defined in OpenAPI
